    ...
    <div>
        <table style="width: 100%; border: 1px solid #000; padding: 0px !important;" cellspacing=0>
            ...
            <tbody style="width: 100%">
                @for ($i = 0; $i < 20; $i++)
                <tr>
                    <td style="border-right: 1px solid #000; width: 25%;">Branch Code</td>
                    <td style="border-right: 1px solid #000; width: 35%;">Branch</td>
                    <td style="border-right: 1px solid #000; width: 20%;">Total No. of Boxes</td>
