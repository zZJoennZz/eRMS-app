...
export default function RDSRecordHistory() {
    ...
    const actionText = {
        ...
        BRANCH_HEAD_APPROVE_WITHDRAW: "Branch Head Approved Withdrawal",
        WAREHOUSE_APPROVE_WITHDRAW: "Warehouse Custodian Approved Withdrawal",
        RECORD_CUST_RECEIVE: "Record Custodian Received Box",
        INITIATE_TRANSFER: "Transfer Request Initiated",
        BRANCH_HEAD_APPROVE_TRANSFER: "Branch Head Approved Transfer",
        WAREHOUSE_RECEIVE: "Warehouse Custodian Received Box",
